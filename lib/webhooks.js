...
class Webhooks {
    ...
    list(options = {}, cb) {
        ...
        if (options.script) {
            ...
            if (!self.api._.user && self.api._.auth_rules && self.api._.auth_rules.webhooks.get !== 'public') {
        ...
        function main() {
            request.get({
                json: true,
                url: new URL('/api/webhooks', self.api._.url),
    ...
    get(options = {}, cb) {
        ...
        function main() {
            ...
            request({
                method: 'GET',
                url: new URL(`/api/webhooks/${options.id}`, self.api._.url),
                auth: self.api._.user
            }, (err, res) => {
                if (err) return cb(err);
    ...
    delete(options = {}, cb) {
        ...
        if (options.script) {
            ...
            if (!self.api._.user && self.api._.auth_rules && self.api._.auth_rules.webhooks.set !== 'public') {
                args = args.concat(auth(self.api._.user));
            }
