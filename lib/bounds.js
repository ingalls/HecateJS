...
class Bounds {
    ...
    stats(options = {}, cb) {
        ...
        if (options.script) {
            ...
            if (!self.api._.user && self.api.auth_rules && self.api.auth_rules.stats.get !== 'public') {
                args = args.concat(auth(self.api._.user));
            }
        ...
        function main() {
            ...
            request({
                method: 'GET',
                json: true,
                url: new URL(`/api/data/bounds/${options.bound}/stats`, self.api._.url),
                auth: self.api._.user
            }, (err, res) => {
    ...
    list(options = {}, cb) {
        ...
        if (options.script) {
            ...
            if (!self.api._.user && self.api.auth_rules && self.api.auth_rules.bounds.list !== 'public') {
                args = args.concat(auth(self.api._.user));
            }
        ...
        function main() {
            request({
                method: 'GET',
                json: true,
                url: new URL('/api/data/bounds', self.api._.url),
                auth: self.api._.user
            }, (err, res) => {
                if (err) return cb(err);
                if (res.statusCode !== 200) return cb(new Error(JSON.stringify(res.body)));
    ...
    get(options = {}, cb) {
        ...
        if (options.script) {
            ...
            if (!self.api._.user && self.api.auth_rules && self.api.auth_rules.bounds.get !== 'public') {
                args = args.concat(auth(self.api._.user));
            }
        ...
        function main() {
            ...
            request({
                method: 'GET',
                url: new URL(`/api/data/bounds/${options.bound}`, self.api._.url),
                auth: self.api._.user
            }).on('error', (err) => {
                return cb(err);
            }).on('response', (res) => {
    ...
    meta(options = {}, cb) {
        ...
        function main() {
            ...
            request({
                method: 'GET',
                url: new URL(`/api/data/bounds/${options.bound}/meta`, self.api._.url),
                auth: self.api._.user
            }, (err, res) => {
                if (err) return cb(err);
                if (res.statusCode !== 200) return cb(new Error(JSON.stringify(res.body)));
    ...
    delete(options = {}, cb) {
        ...
        if (options.script) {
            ...
            if (!self.api._.user && self.api.auth_rules && self.api.auth_rules.bounds.delete !== 'public') {
                args = args.concat(auth(self.api._.user));
            }
    ...
    set(options = {}, cb) {
        ...
        if (options.script) {
            ...
            if (!self.api._.user && self.api.auth_rules && self.api.auth_rules.bounds.create !== 'public') {
                args = args.concat(auth(self.api._.user));
            }
