...
class Import {
    ...
    multi(options = {}, cb) {
        ...
        if (options.script) {
            ...
            if (!self.api._.user && self.api._.auth_rules && self.api._.auth_rules.feature.create !== 'public') {
        ...
        function main() {
            ...
            self.api.server.get({}, (err, server) => {
                ...
                self.api.schema.get({}, (err, schema) => {
            ...
            function upload(body, upload_cb) {
                ...
                request({
                    method: 'POST',
                    url: new URL('/api/data/features', self.api._.url),
                    headers: {
