    ...
    deltas(options = {}, cb) {
        ...
        if (options.script) {
            ...
            if (
                (
                    !self.api._.user
                    && self.api._.auth_rules
                ) && (
                    self.api._.auth_rules.feature.get !== 'public'
                    || self.api._.auth_rules.feature.history !== 'public'
                    || self.api._.auth_rules.delta.get !== 'public'
                    || self.api._.auth_rules.delta.list !== 'public'
                )
            ) {
